...
namespace VersionManager\Core\Extension\Drivers\Sysvmsg;
...
class Base extends AbstractExtensionDriver
{
    ...
    public function install($phpVersion, array $options = [])
    {
        ...
        if (empty($output)) {
            ...
            throw new \Exception("当前 PHP 版本不支持 Sysvmsg 扩展，需要重新编译 PHP");
        }
