...
namespace VersionManager\Core\Extension\Drivers\Redis;
...
class Base extends AbstractExtensionDriver
{
    ...
    {
        $command = 'apt-get update && apt-get install -y libhiredis-dev';
    ...
    {
        $command = 'yum install -y hiredis-devel';
    ...
    {
        $command = 'apk add --no-cache hiredis-dev';
