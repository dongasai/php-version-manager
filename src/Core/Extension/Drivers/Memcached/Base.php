...
namespace VersionManager\Core\Extension\Drivers\Memcached;
...
class Base extends AbstractExtensionDriver
{
    ...
    {
        $command = 'apt-get update && apt-get install -y libmemcached-dev zlib1g-dev';
    ...
    {
        $command = 'yum install -y libmemcached-devel zlib-devel cyrus-sasl-devel';
    ...
    {
        $command = 'apk add --no-cache libmemcached-dev zlib-dev cyrus-sasl-dev';
