...
$user->id = 1;
$user->name = "Test";
echo "类型化属性: id={$user->id}, name={$user->name}\n";

// 空合并赋值运算符
$array = [];
$array['key'] ??= 'value';
echo "空合并赋值运算符: " . $array['key'] . "\n";

echo "\nPHP 7.4安装完成!\n";
EOF

echo -e "${GREEN}测试文件已创建: $(pwd)/php74_test.php${NC}"
echo -e "${YELLOW}您可以运行 'php php74_test.php' 来测试PHP 7.4环境${NC}"
